...
void protobuf_AddDesc_gcsdk_5fgcmessages_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "emoved\030\004 \003(\0132#.CMsgSOMultipleObjects.Sin"
    "gleObject\022:\n\robjects_added\030\005 \003(\0132#.CMsgS"
    ...
    " \001(\0162\023.GCConnectionStatus\022\033\n\023client_sess"
    ...
    "ncherType_DEFAULT\020\000\022%\n!GCClientLauncherT"
    "ype_PERFECTWORLD\020\001*\325\001\n\022GCConnectionStatu"
    "s\022#\n\037GCConnectionStatus_HAVE_SESSION\020\000\022$"
    "\n GCConnectionStatus_GC_GOING_DOWN\020\001\022!\n\035"
    "GCConnectionStatus_NO_SESSION\020\002\0220\n,GCCon"
    "nectionStatus_NO_SESSION_IN_LOGON_QUEUE\020"
    "\003\022\037\n\033GCConnectionStatus_NO_STEAM\020\004B\005H\001\200\001"
    "\000", 4401);
...
void CMsgSOSingleObject::SerializeWithCachedSizes(
  ...
  // optional fixed64 type_id = 2;
  if (has_type_id()) {
    ::google::protobuf::internal::WireFormatLite::WriteFixed64(2, this->type_id(), output);
  }
...
::google::protobuf::uint8* CMsgSOSingleObject::SerializeWithCachedSizesToArray(
  ...
  // optional fixed64 type_id = 2;
  if (has_type_id()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteFixed64ToArray(2, this->type_id(), target);
  }
  ...
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 3: {
        ...
        if (input->ExpectTag(34)) goto parse_objects_removed;
        break;
      }

      // repeated .CMsgSOMultipleObjects.SingleObject objects_removed = 4;
      case 4: {
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
            ::google::protobuf::internal::WireFormatLite::WIRETYPE_LENGTH_DELIMITED) {
        ...
        if (input->ExpectTag(34)) goto parse_objects_removed;
        if (input->ExpectTag(42)) goto parse_objects_added;
        break;
      }

      // repeated .CMsgSOMultipleObjects.SingleObject objects_added = 5;
      case 5: {
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
            ::google::protobuf::internal::WireFormatLite::WIRETYPE_LENGTH_DELIMITED) {
         parse_objects_added:
...
void CMsgSOMultipleObjects::SerializeWithCachedSizes(
  ...
  for (int i = 0; i < this->objects_removed_size(); i++) {
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
      4, this->objects_removed(i), output);
  }

  // repeated .CMsgSOMultipleObjects.SingleObject objects_added = 5;
  for (int i = 0; i < this->objects_added_size(); i++) {
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
      5, this->objects_added(i), output);
  }
...
::google::protobuf::uint8* CMsgSOMultipleObjects::SerializeWithCachedSizesToArray(
  ...
  for (int i = 0; i < this->objects_removed_size(); i++) {
    target = ::google::protobuf::internal::WireFormatLite::
      WriteMessageNoVirtualToArray(
        4, this->objects_removed(i), target);
  }
      ...
      case 2: {
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
         ...
         parse_gc_type:
          DO_((::google::protobuf::internal::WireFormatLite::ReadRepeatedPrimitive<
                   ::google::protobuf::uint32, ::google::protobuf::internal::WireFormatLite::TYPE_UINT32>(
                 1, 16, input, this->mutable_gc_type())));
        } else if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag)
                   == ::google::protobuf::internal::WireFormatLite::
                      WIRETYPE_LENGTH_DELIMITED) {
          DO_((::google::protobuf::internal::WireFormatLite::ReadPackedPrimitiveNoInline<
                   ::google::protobuf::uint32, ::google::protobuf::internal::WireFormatLite::TYPE_UINT32>(
                 input, this->mutable_gc_type())));
        } else {
          goto handle_uninterpreted;
        }
        if (input->ExpectTag(16)) goto parse_gc_type;
...
void CGCToGCMsgMasterAck::SerializeWithCachedSizes(
  ...
  // repeated uint32 gc_type = 2;
  for (int i = 0; i < this->gc_type_size(); i++) {
    ::google::protobuf::internal::WireFormatLite::WriteUInt32(
      2, this->gc_type(i), output);
  }
...
::google::protobuf::uint8* CGCToGCMsgMasterAck::SerializeWithCachedSizesToArray(
  ...
  for (int i = 0; i < this->gc_type_size(); i++) {
    target = ::google::protobuf::internal::WireFormatLite::
      WriteUInt32ToArray(2, this->gc_type(i), target);
  }
  ...
  // repeated uint32 gc_type = 2;
  {
    ...
    for (int i = 0; i < this->gc_type_size(); i++) {
      data_size += ::google::protobuf::internal::WireFormatLite::
        UInt32Size(this->gc_type(i));
    }
    total_size += 1 * this->gc_type_size() + data_size;
  }
...
void CGCToGCMsgMasterAck::MergeFrom(const CGCToGCMsgMasterAck& from) {
  GOOGLE_CHECK_NE(&from, this);
  gc_type_.MergeFrom(from.gc_type_);
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
